# sysnc_trans_subtitle
多國語言同步翻譯字幕 Multi-language simultaneous subtitles
這是一個用python 撰寫的同步翻譯字幕,適合授課使用,可自行調整字幕位置,並設定專有名詞字典
程式使用Azure SPEECH SDK 及 Google翻譯API
